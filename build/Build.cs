...
#pragma warning restore CS0649
    ...
    readonly string SonarProjectKey = "tamp-build_tamp-azure-cli";
    ...
    Target Test => _ => _
        ...
        .Description("Unit tests only — integration tests need `az` on PATH.")
        .Executes(() => DotNet.Test(s => s
            .SetProject(RootDirectory / "tests" / "Tamp.AzureCli.V2.Tests" / "Tamp.AzureCli.V2.Tests.csproj")
            .SetConfiguration(Configuration)
            .SetNoBuild(true)
    ...
    Target Pack => _ => _
        ...
        {
            s.SetProject(RootDirectory / "src" / "Tamp.AzureCli.V2" / "Tamp.AzureCli.V2.csproj");
